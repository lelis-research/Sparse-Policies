...
class LevinLossMLP:
    ...
    def _run_y1_y2(self, env, option, number_steps):
            """
    ...
    def compute_loss_y1_y2(self, options_list, problem_of_option, trajectories, number_actions, number_steps):
        """
        ...
        for problem, trajectory in trajectories.items():
            ...
            name_list = [problem for _ in range(len(trajectory._sequence))]
            joint_problem_name_list = joint_problem_name_list + name_list
        return self.loss_y1_y2(options_list, chained_trajectory, number_actions, joint_problem_name_list, problem_of_option, number_steps)
