        ...
        if multi_problem:
            for seq, problem_state_list in uniq_seq_dict.items():
                for problem, states_tuple in problem_state_list:
                    ...
                    option = process_option(uniq_seq_dict, problem, seq, states_tuple, input_size, output_size_y1, hidden_size_custom_relu, learning_rate, l1_lambda, batch_size, num_epochs, multi_problem, args.print_loss)
